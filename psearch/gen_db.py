...
def create_conformations_db(db_name, rdk_molecules, ncpu, bin_step=1, db_filename=None, flag="n", pharm_def=None, verbose=True):
    if verbose:
        sys.stderr.write('Database creation started\n')

    start_time = time.time()

    db = DB(db_name=db_name, filename=db_filename, flag=flag)
